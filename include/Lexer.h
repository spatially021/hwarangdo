...
protected:
  ...
  std::unordered_map<std::string, TKind> keyword_map = {
      ...
      {"throw", TKind::THROW},       {"super", TKind::SUPER},
      {"this", TKind::THIS},         {"i8", TKind::SIZE},
      {"i16", TKind::SIZE},          {"i32", TKind::SIZE},
      {"i64", TKind::SIZE},          {"i128", TKind::SIZE},
      {"f16", TKind::SIZE},          {"f32", TKind::SIZE},
      {"f64", TKind::SIZE},          {"f128", TKind::SIZE},
      ...
      {"init", TKind::INIT},         {"self", TKind::SELF}};
};
